  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const prompt =
        ...
        " Answer: " +
        answer +
        " based on this Answer give me a rating from 10 and a feedback(of 3-5 lines) and correct answer. this three feilds(feedback, rating and correctAnswer) should be in json fromat.";
    ...
    <div className="flex flex-col border rounded-md rounder-md p-5 gap-3 relative">
      {error || useTextInput ? (
        ...
        <>
          ...
          <Webcam className="h-72 w-full  " mirrored={true} />
      ...
      <div className="flex justify-center  sm:justify-end">
        <Button className="w-40 " disabled={loading} onClick={handleSubmit}>
          {loading ? (
